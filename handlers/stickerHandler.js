    ...
    if (message.hasMedia && message.body.trim() === '#sticker') {
        ...
        try {
            ...
            if (isImage) {
                ...
                const cmd = `ffmpeg -i "${tempInputPath}.${inputExt}" -vf "fps=15,scale=512:-1,crop=512:512" -c:v libwebp -lossless 1 -preset default -loop 0 -an -vsync 0 -t 6 -y "${tempOutputPath}"`;
